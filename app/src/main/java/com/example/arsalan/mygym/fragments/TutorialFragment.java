...
import com.example.arsalan.mygym.Objects.TutorialGroup;
...
public class TutorialFragment extends Fragment {
    ...
    class AdapterTutorial extends BaseAdapter {
        ...
        public AdapterTutorial() {
            for (int i = 0; i < 10; i++)
                this.tutorialGroups.add(new TutorialGroup("تمرین های شکم", R.drawable.tutorial));
        }
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            SimpleDraweeView thumb = view.findViewById(R.id.imgThumb);
            nameTV.setText(tutorialGroups.get(i).getName());
            thumb.setActualImageResource(tutorialGroups.get(i).getThumbRes());
